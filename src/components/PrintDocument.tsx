...
export function buildBlocks(product: Product, opts: { includeCost?: boolean } = {}): React.ReactElement[] {
  ...
  const band: React.CSSProperties = {
    background: "#497160", color: "#fff", fontWeight: 700, letterSpacing: "0.1em",
    textAlign: "center", padding: compact ? "5px" : "7px", margin: "0 0 6px", fontSize: fBand,
  };
  ...
  // タイトル + 商品名
  blocks.push(
    <div key="title" data-pdf-block style={{ breakInside: "avoid" }}>
      <div style={{ background: "#243e33", color: "#fff", textAlign: "center", fontSize: 24, fontWeight: 700, padding: "12px", letterSpacing: "0.15em" }}>商 品 企 画 書</div>
  ...
  if (big) {
    blocks.push(
      <div key="images" data-pdf-block style={blk}>
    ...
    blocks.push(
      <div key="appeal" data-pdf-block style={blk}>
    ...
    blocks.push(
      <div key="imagerow" data-pdf-block style={{ ...blk, display: "flex", gap: 12 }}>
        <div style={{ flex: 1 }}>
          <div style={band}>商 品 画 像</div>
  ...
  // 商品説明
  blocks.push(
    <div key="desc" data-pdf-block style={blk}>
  ...
  // 価格
  blocks.push(
    <div key="price" data-pdf-block style={blk}>
  ...
  // 仕様
  blocks.push(
    <div key="spec" data-pdf-block style={blk}>
  ...
  // バーコード
  blocks.push(
    <div key="barcode" data-pdf-block style={blk}>
  ...
  // サイズ
  blocks.push(
    <div key="size" data-pdf-block style={blk}>
  ...
  // その他
  if (p.testInfo || p.separateItems || p.notes || p.remarks) {
    blocks.push(
      <div key="other" data-pdf-block style={blk}>
  ...
  // 詳細画像
  if (p.detailImages.length > 0) {
    blocks.push(
      <div key="detail" data-pdf-block style={blk}>
  ...
  // 注記
  blocks.push(
    <div key="note" data-pdf-block style={{ breakInside: "avoid", marginTop: 8 }}>
  ...
  // フッター（ロゴ＋会社情報）
  blocks.push(
    <div key="footer" data-pdf-block style={{ breakInside: "avoid", marginTop: 14, display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid #969696", paddingTop: 8 }}>
      <Logo height={22} />
